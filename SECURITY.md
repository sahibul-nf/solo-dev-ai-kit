...
| `scripts/gh-*.sh`, `scripts/README.md` | Yes | Shell scripts; no embedded secrets |
| `docs/how-to-run.md` | Yes* | Replace all `TBD`; no secrets |
| `docs/troubleshooting.md`, `docs/close-comment.example.md` | Yes | Help & templates only |
